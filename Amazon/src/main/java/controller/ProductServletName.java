...
@WebServlet("/ProductServletName")
public class ProductServletName extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public ProductServletName() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Product product = ProductDAO.instance.searchName(id,manu);
		if(product.flag==0) {
